      ...
      */}
      <div className="w-full bg-white rounded-bl-[30px] sm:rounded-bl-[40px] lg:rounded-bl-[80px] pt-[16px] sm:pt-[24px] lg:pt-[60px] pb-[32px] sm:pb-[48px] lg:pb-[100px] px-[20px] lg:px-[60px]">
        <div className="max-w-[1320px] mx-auto flex flex-col items-start lg:items-center">
            ...
            >
              {testimonialsData.map((item, idx) => (
                <div 
                  ...
                  className="w-full shrink-0 flex flex-col lg:flex-row gap-[20px] sm:gap-[28px] lg:gap-[60px] items-start"
                >
                  {/* Left Image Side */}
                  ...
                  <div className="flex flex-col justify-center flex-1">
                    <p className="font-secondary font-normal text-[15px] sm:text-[16px] lg:text-[20px] leading-[1.5] text-[#111111] mb-[16px] sm:mb-[20px] lg:mb-[40px]">
                      {item.quote}
                    </p>

                    <div className="flex flex-col gap-[2px] lg:gap-[6px]">
                      <span className="font-primary font-normal text-[22px] sm:text-[24px] lg:text-[32px] text-electric-blue leading-[1.2]">
                        {item.name}
                      </span>
          ...
          <div className="flex items-center justify-between w-full mt-[16px] sm:mt-[20px] lg:mt-[48px]">
            {/* Dots */}
            <div className="flex items-center gap-[6px] lg:gap-[8px]">
              {testimonialsData.map((_, i) => (
                <button
                  ...
                  className={`h-[4px] lg:h-[7px] rounded-[32px] transition-all duration-300 cursor-pointer p-0 border-none outline-none ${
                    currentIndex === i 
                      ? 'w-[24px] lg:w-[40px] bg-electric-blue' 
                      : 'w-[6px] lg:w-[12px] bg-[#91C6F2]'
                  }`}
                />
              ))}
            </div>
            ...
            <div className="hidden lg:flex items-center gap-[12px]">
              ...
              <button 
                ...
                className={`group w-[48px] h-[48px] rounded-full border border-electric-blue flex items-center justify-center transition-all duration-300 cursor-pointer focus:outline-none ${
                  currentIndex === 0 
