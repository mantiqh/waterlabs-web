...
export const EligibilitySection = ({
  tag = DEFAULT_HOME_DATA.eligibilityTag,
  heading = DEFAULT_HOME_DATA.eligibilityHeading,
  subtag = DEFAULT_HOME_DATA.eligibilitySubtag,
  subheading = DEFAULT_HOME_DATA.eligibilitySubheading,
  diagramImage = DEFAULT_HOME_DATA.eligibilityDiagramImage ||
    '/images/home/eligibility-images/img_eliigibility_to_coding.png',
  description = DEFAULT_HOME_DATA.eligibilityDescription,
  bgDesktop = DEFAULT_HOME_DATA.eligibilityBgDesktop ||
    '/images/home/eligibility-images/we_offer_end_to_end_coverage_desktop.png',
  bgMobile = DEFAULT_HOME_DATA.eligibilityBgMobile ||
    ...
    <section className="relative w-full bg-white">
      <div className="relative w-full md:w-[calc(100%-40px)] lg:w-[min(calc(100vw-60px),calc(50vw+660px))] mr-auto rounded-tr-[30px] rounded-br-[30px] lg:rounded-tr-[60px] lg:rounded-br-[60px] px-[20px] md:px-[40px] py-[40px] lg:py-[80px] lg:pl-[max(60px,calc((100vw-1320px)/2))] lg:pr-[60px] flex flex-col justify-between gap-[36px] lg:gap-[48px] overflow-hidden isolate bg-[#0F68D6]">
        ...
        <div className="relative z-10 w-full flex flex-col gap-[16px] lg:gap-[20px]">
          ...
          <h2 className="type-h2 text-white max-w-[702px] whitespace-pre-line">
            {heading}
          </h2>
        </div>
        ...
        <div className="relative z-10 w-full flex flex-col lg:flex-row items-center justify-between gap-[24px] lg:gap-[20px] xl:gap-[32px]">
          ...
          <div className="w-full lg:w-auto lg:flex-1 min-w-0 xl:max-w-[315px] flex flex-col justify-center gap-[12px] lg:gap-[16px]">
            {subtag && (
              <span className="type-h6 text-white">{subtag}</span>
            )}
            <h3 className="type-h3 text-white whitespace-pre-line">
              {subheading}
            </h3>
          </div>
          ...
          <div className="w-full lg:w-auto lg:flex-1 min-w-0 xl:max-w-[315px] flex flex-col justify-center">
            <p className="type-h6 text-white">{description}</p>
          </div>
        </div>
      </div>
    </section>
