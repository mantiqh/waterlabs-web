...
import type { BillingStepItem } from '@/types/home';
...
export const BillingSection = ({
  tag = DEFAULT_HOME_DATA.billingTag,
  headingHighlight = DEFAULT_HOME_DATA.billingHeadingHighlight,
  heading = DEFAULT_HOME_DATA.billingHeading,
  description = DEFAULT_HOME_DATA.billingDescription,
  steps = DEFAULT_HOME_DATA.billingSteps,
  points = DEFAULT_HOME_DATA.billingPoints || [
    'No development fee',
    'No software license',
        ...
        <div className="max-w-[1320px] mx-auto flex flex-col gap-[40px] lg:gap-[56px]">
          ...
          <div className="flex flex-col lg:flex-row items-start justify-between gap-[24px] lg:gap-[60px]">
            ...
            <div className="flex-1 flex flex-col gap-[16px] lg:gap-[20px]">
              ...
              <p className="type-body-s text-[#4B5563]">{description}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-[32px] lg:gap-[48px] items-stretch">
              ...
              {steps.map((step, idx) => (
                ...
                >
                  ...
                  <div className="hidden lg:flex items-start gap-[28px]">
                    <span
                      className={`type-h2 !leading-[1] shrink-0 w-[72px] ${
                    ...
                    <div className="flex-1 flex flex-col gap-[8px]">
                      <div className="flex items-center justify-between gap-[16px]">
                        <h6 className="type-h6 text-[#111111]">{step.title}</h6>
                        <span
                          className={`type-body-xxs !font-normal px-[16px] py-[5px] rounded-tl-[16px] rounded-bl-[16px] rounded-br-[16px] rounded-tr-none shrink-0 ${
                      ...
                      <p className="type-body-xxs text-[#111111] whitespace-pre-line">
                        {step.desc}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex lg:hidden flex-col gap-[12px]">
                    <div className="flex items-center">
                      <span
                        className={`type-caption px-[12px] py-[4px] rounded-tl-[12px] rounded-bl-[12px] rounded-br-[12px] rounded-tr-none ${
                          step.dayVariant === 'active'
                            ? 'bg-[#91C6F2] text-[#111111]'
                            : 'bg-white border border-[#91C6F2] text-[#111111]'
                        }`}
                    ...
                    <h5 className="type-h5 text-electric-blue">{step.title}</h5>
                    <p className="type-body-xxs text-[#111111] whitespace-pre-line">
                      {step.desc}
                    </p>
                  </div>
            ...
            <div className="lg:col-span-5 flex items-center justify-center lg:justify-end">
              <div
                ...
                style={{
                  background:
                    'linear-gradient(137.1deg, #042849 29.61%, #0A60AF 99.37%)',
                }}
              >
                {points.map((pt, i) => (
                  <span
                    key={`point-${i}`}
                    className="type-h5 text-left lg:text-center text-white lg:max-w-[280px]"
                  >
                    {pt}
                  </span>
                ))}
