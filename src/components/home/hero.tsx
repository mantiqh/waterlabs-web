...
const Hero: React.FC<HeroProps> = ({ data }) => {
  return (
    <section className="relative w-full">
      <div
        className={`flex flex-col justify-between gap-[40px] lg:gap-0 w-full min-h-[581px] lg:min-h-[850px] rounded-br-[30px] lg:rounded-br-[60px] bg-cover bg-center bg-no-repeat pt-[20px] px-[20px] md:px-[40px] pb-[40px] lg:pt-[40px] lg:px-[60px] lg:pb-[80px] ${!data?.heroBackgroundImageUrl ? "bg-[url('/images/home/hero-bg-mobile.png')] lg:bg-[url('/images/home/hero-bg.png')]" : ""}`}
        style={data?.heroBackgroundImageUrl ? { backgroundImage: `url('${data.heroBackgroundImageUrl}')` } : undefined}
      >
        <Navbar />

        {/* Hero Content Area */}
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between w-full max-w-[1320px] mx-auto gap-[20px] lg:gap-[40px] xl:gap-[80px] 2xl:gap-[120px]">
