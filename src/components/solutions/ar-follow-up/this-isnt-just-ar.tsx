...
const threeThingsCards: ThreeThingsCard[] = [
  {
    ...
    title: 'Start small',
    description:
      'You may begin with AR follow-up only and add additional stages when ready.',
  },
  {
...
export const ThisIsntJustARSection = () => {
        ...
        <div className="max-w-[1320px] mx-auto flex flex-col gap-[32px] lg:gap-[60px]">
          ...
          >
            ...
            <div className="w-full lg:w-[45%] xl:w-1/2 flex flex-col items-start gap-[12px] xl:gap-[20px] p-[24px] lg:p-[32px] xl:p-[60px] justify-center">
              ...
              <p className="type-body-xs text-[#F4F6F9]">
                AR follow-up runs on our proprietary HIMER AI OS, which also manages prior authorization, eligibility, denials, cash posting, and coding. What our AR agent learns about payer stalls is used by our submission agent to prevent them.
              </p>
            ...
            <div className="w-full lg:w-[55%] xl:w-1/2 self-stretch flex items-center justify-end overflow-hidden">
              <div className="relative w-full h-full min-h-[380px] xl:min-h-[500px]">
                <Image
                  src="/images/solutions/solutions-AR-follow-up/this-isn't-just-an-eligibility-tool/img_this_isn't_just_an_eligibility_tool%20(1).png"
          ...
          >
            <div className="w-full overflow-hidden rounded-[20px] md:h-[380px] md:relative">
              <Image
                src="/images/solutions/solutions-AR-follow-up/this-isn't-just-an-eligibility-tool/img_this_isn't_just_an_eligibility_tool%20(2).png"
                alt="HIMER AI OS platform overview"
                width={724}
                height={596}
                priority
...
export default ThisIsntJustARSection;
