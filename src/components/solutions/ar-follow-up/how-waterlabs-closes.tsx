...
const verificationSteps: VerificationStep[] = [
  {
    ...
    description:
      'Our agents check claim status directly with the payer on cycle, not waiting for a remittance to explain itself.',
  },
  {
    title: 'Payer follow-up',
    description:
      'The system works the portal, follows up on the claim, and documents what the payer said.',
  },
  {
    title: 'Aging bucket coverage',
    description:
      '30, 60, 90, and 120-plus are worked identically. Age does not determine priority.',
  },
  {
    title: 'Stall detection',
    description:
      'Claims that have gone quiet are flagged before aging into the next bucket.',
  },
  {
    title: 'Escalation',
    description:
      'Our agents push what needs pushing and route anything requiring a human to your team.',
  },
  {
    title: 'Documentation',
    description:
      'Every touch is logged, so the next action always starts from the last one.',
  },
];
      ...
      >
        <div className="w-full max-w-[1320px] flex flex-col gap-[20px] lg:gap-[32px]">
          ...
          <p className="type-body-xs text-[#D7DCE2] max-w-[873px]">
            Our agents work every bucket with the same attention, including those a human team would triage away.
          </p>
          ...
          <div className="hidden lg:flex flex-row items-start justify-between gap-[24px] xl:gap-[40px] pt-[20px]">
            ...
            <div className="w-full lg:w-[44%] xl:w-[590px] lg:max-w-[590px] shrink-0 flex flex-col gap-[24px]">
              ...
              <div className="relative w-full aspect-[590/287] rounded-[20px_10px_20px_20px] overflow-hidden">
                <Image
                  src="/images/solutions/solutions-AR-follow-up/how-waterlabs-closes/img_waterlab_closes_the_gap%20(4).png"
