          ...
          <div className="flex flex-col gap-[20px] lg:gap-[32px]">
            ...
            <div className="w-full bg-ghost-white rounded-[20px] p-[20px] md:p-[32px] lg:p-[40px] flex flex-col lg:flex-row gap-[24px] lg:gap-[40px]">
              ...
              <div className="flex-1 flex flex-col gap-[8px] lg:gap-[12px]">
                <h3 className="type-h3 text-black">99 to 100%</h3>
                <p className="type-body-xs text-charcoal">posting accuracy</p>
              </div>

              {/* Stat 2 */}
              <div className="flex-1 flex flex-col gap-[8px] lg:gap-[12px]">
                <h3 className="type-h3 text-black">Within 48 hours</h3>
                <p className="type-body-xs text-charcoal">posting lag</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-[24px] lg:gap-[32px]">
            ...
            <div className="w-full lg:flex-1 lg:max-w-[644px] flex flex-col justify-center gap-[16px] lg:gap-[20px]">
              ...
              <p className="type-body-xs text-[#111111] max-w-[644px]">
                Unbalanced remittances, disputed adjustments, and anything needing a decision on application are routed to your team. The remittance and claim arrive side by side, matched as far as our agents could take them.
              </p>
            </div>
            ...
            <div className="w-full lg:flex-1 lg:max-w-[644px]">
              ...
              <div className="hidden lg:block relative w-full aspect-[644/309] rounded-[30px_10px_30px_30px] overflow-hidden">
                <Image
                  src="/images/solutions/solutions-payment-posting/human-in-the-loop/Frame%202147203302%20(3).png"
                  alt="Human in the loop reviewing unbalanced remittances and payment adjustments"
                  fill
                  priority
              ...
              <div className="block lg:hidden relative w-full aspect-[362/156] rounded-[20px_10px_20px_20px] overflow-hidden">
                <Image
                  src="/images/solutions/solutions-payment-posting/human-in-the-loop/img_human_in_the_loop%20(1).png"
                  alt="Human in the loop reviewing unbalanced remittances and payment adjustments"
                  fill
                  priority
