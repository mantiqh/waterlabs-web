...
const threeThingsCards: ThreeThingsCard[] = [
  {
    ...
    title: 'Start small',
    description:
      'You may begin with denial management only and add additional stages when ready.',
  },
  {
...
export const ThisIsntJustDenialsSection = () => {
        ...
        <div className="max-w-[1320px] mx-auto flex flex-col gap-[32px] lg:gap-[60px]">
          ...
          >
            ...
            <div className="w-full lg:w-[45%] xl:w-1/2 flex flex-col items-start gap-[12px] xl:gap-[20px] p-[24px] lg:p-[32px] xl:p-[60px] justify-center">
              <div className="flex items-center gap-[8px]">
                ...
                <span className="type-body-xxs text-[#F4F6F9] tracking-[0.01em]">
                  This isn&apos;t just a denials tool
                </span>
              </div>
              ...
              <p className="type-body-xs text-[#F4F6F9]">
                Denial management runs on our proprietary HIMER AI OS, which also manages prior authorization, eligibility, accounts receivable, cash posting, and coding. Our denial agent can trace a denial back to the authorization that caused it, and what it learns goes back into the system.
              </p>
            ...
            <div className="w-full lg:w-[55%] xl:w-1/2 self-stretch flex items-center justify-end overflow-hidden">
              <div className="relative w-full h-full min-h-[380px] xl:min-h-[500px]">
                <Image
                  src="/images/solutions/solutions-denialmanagement/this-isn't-just-an-eligibility-tool/img_this_isn't_just_an_eligibility_tool%20(1).png"
          ...
          >
            <div className="w-full overflow-hidden rounded-[20px] md:h-[380px] md:relative">
              <Image
                src="/images/solutions/solutions-denialmanagement/this-isn't-just-an-eligibility-tool/img_this_isn't_just_an_eligibility_tool%20(2).png"
                alt="HIMER AI OS platform overview"
                width={724}
                height={596}
                priority
              ...
              <div className="flex flex-row items-center gap-[5px] pt-[8px]">
                {Array.from({ length: TOTAL_DOTS }).map((_, i) => {
                  ...
                  const widthClass = isActive
                    ...
                    : diff === 1
                    ? 'w-[16px] bg-electric-blue/30'
                    : 'w-[6px] bg-electric-blue/30';

                  return (
                    <button
                      key={`dot-denials-three-${i}`}
                      type="button"
...
export default ThisIsntJustDenialsSection;
