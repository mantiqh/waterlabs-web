        ...
        <div className="max-w-[1320px] mx-auto">
          ...
          <div className="hidden lg:flex flex-row items-stretch justify-between gap-[20px]">
            ...
            <div className="relative w-full lg:flex-[1.766] lg:max-w-[830px] min-w-0 min-h-[456px] rounded-[30px_10px_30px_30px] overflow-hidden">
              <Image
                src="/images/solutions/solutions-denialmanagement/the-problem/img_the_problem%20(6).png"
                alt="Healthcare staff reviewing denied claims and appeals"
                fill
                priority
              ...
              <div className="relative z-10 flex flex-col items-start p-[24px] xl:p-[20px_32px] gap-[14px]">
                ...
                <div className="flex flex-col gap-[14px]">
                  <p className="type-body-xxs text-[#2A2A2A] tracking-[0.01em]">
                    Most denials are appealable but never appealed because working one requires a person, and people run out before the pile does. The write-off threshold in most practices was never chosen; it is whatever the team could handle.
                  </p>
                  <p className="type-body-xxs text-[#2A2A2A] tracking-[0.01em]">
                    Initial denial rates have risen from around 10% to nearly 12% in recent years, and 41% of providers now report denial rates above 10%.
                  </p>
                </div>
              </div>
            </div>
