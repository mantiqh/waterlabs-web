...
const threeThingsCards: ThreeThingsCard[] = [
  {
    ...
    title: 'Start small',
    description:
      'You may begin with charge capture and coding only and add additional stages when ready.',
  },
  {
...
export const ThisRunsOnCurieCodeSection = () => {
  ...
  return (
    ...
    >
      {/*
        "This runs on CurieCode" + Three Things Section:
      ...
      */}
      <div className="w-full bg-ghost-white rounded-tl-[30px] rounded-bl-[30px] lg:rounded-tl-[60px] lg:rounded-bl-[60px] px-[20px] md:px-[40px] lg:px-[60px] py-[40px] md:py-[60px] lg:py-[60px]">
        <div className="max-w-[1320px] mx-auto flex flex-col gap-[32px] lg:gap-[60px]">
          ...
          {/* ── GRADIENT CARD: "Coding has its own product." ── */}
          ...
          >
            ...
            <div className="w-full lg:w-[48%] xl:w-1/2 flex flex-col items-start gap-[12px] xl:gap-[20px] p-[24px] lg:p-[32px] xl:p-[60px] justify-center">
              {/* Tag */}
              <div className="flex items-center gap-[8px]">
                <div className="w-[8px] h-[8px] rounded-full bg-[#91C6F2] shrink-0" />
                <span className="type-body-xxs text-[#F4F6F9] tracking-[0.01em]">
                  This runs on CurieCode
                </span>
              </div>

              {/* Heading */}
              <h3 className="type-h3 text-white tracking-[-0.01em]">
                Coding has its own product.
              </h3>

              {/* Description */}
              <p className="type-body-xs text-[#F4F6F9]">
                Charge capture and coding run on CurieCode, our agentic coding engine built on a proprietary code book and trained on hundreds of thousands of real coding decisions and their payer outcomes. CurieCode is also available on HIMER AI OS, so a coding decision that would cause a denial 45 days later does not get lost.
              </p>

              {/* CTAs */}
              <div className="flex flex-wrap items-center gap-[12px] pt-[4px]">
                <Link href="/products/curiecode">
                  <CTA variant="dark-bg">
                    Explore CurieCode
                  </CTA>
                </Link>
            ...
            {/* Right Column: Image */}
            <div className="w-full lg:w-[52%] xl:w-1/2 self-stretch flex items-center justify-end overflow-hidden">
              <div className="relative w-full h-full min-h-[380px] xl:min-h-[500px]">
                <Image
                  src="/images/solutions/solutions-charge-capture-&-coding/this-isn't-just-an-eligibility-tool/img_this_isn't_just_an_eligibility_tool%20(1).png"
                  alt="CurieCode platform overview"
                  fill
                  priority
          ...
          >
            ...
            <div className="w-full overflow-hidden rounded-[20px] md:h-[380px] md:relative">
              <Image
                src="/images/solutions/solutions-charge-capture-&-coding/this-isn't-just-an-eligibility-tool/img_this_isn't_just_an_eligibility_tool%20(2).png"
                alt="CurieCode platform overview"
                width={724}
                height={596}
                priority
...
export default ThisRunsOnCurieCodeSection;
