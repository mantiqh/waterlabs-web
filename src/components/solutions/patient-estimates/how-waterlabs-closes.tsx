...
const verificationSteps: VerificationStep[] = [
  {
    title: 'Triggered at booking',
    description:
      'Our agents begin as soon as an appointment is scheduled, rather than waiting until just before the visit.',
  },
  {
    title: 'Real-time eligibility check',
    description:
      'Coverage and plan details are verified directly with the payer at the time of booking.',
  },
  {
    title: 'Accumulator lookup',
    description:
      'Current deductible, coinsurance, and copay amounts are retrieved to ensure the estimate reflects the patient’s actual financial position.',
  },
  {
    title: 'Specialty fee match',
    description:
      'The contracted rate for the relevant CPT codes is applied for each specialty, rather than using a generic price.',
  },
  {
    title: 'Estimate generation',
    description:
      'A clear, easy-to-understand estimate is created, outlining plan coverage and the patient’s financial responsibility.',
  },
  {
    title: 'Delivery before the visit',
    description:
      'The estimate is sent to the patient via portal, SMS, or email before the date of service.',
  },
  {
    title: 'Write-back to your EHR',
    description:
      'The estimate is recorded in the patient’s record for use by registration and billing teams.',
  },
];
      ...
      >
        <div className="w-full max-w-[1320px] flex flex-col gap-[20px] lg:gap-[32px]">
          ...
          <p className="type-body-xs text-[#D7DCE2] max-w-[873px]">
            Our agents generate an estimate for every scheduled visit without adding extra steps to your team’s workflow.
          </p>
          ...
          <div className="hidden lg:flex flex-row items-start justify-between gap-[24px] xl:gap-[40px] pt-[20px]">
            ...
            <div className="w-full lg:w-[44%] xl:w-[590px] lg:max-w-[590px] shrink-0 flex flex-col gap-[24px]">
              ...
              <div className="relative w-full aspect-[590/287] rounded-[20px_10px_20px_20px] overflow-hidden">
                <Image
                  src="/images/solutions/solutions-patient-estimates/how-waterlabs-closes/img_waterlab_closes_the_gap%20(6).png"
