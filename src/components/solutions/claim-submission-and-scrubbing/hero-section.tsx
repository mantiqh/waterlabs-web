...
export const ClaimSubmissionHeroSection = () => {
  return (
          ...
          <div className="w-full lg:flex-1 lg:max-w-[650px] flex flex-col justify-center gap-[20px] pt-[32px] lg:pt-0">
            ...
            <div className="flex items-center gap-[8px]">
              ...
              <span className="type-body-xxs text-[#D7DCE2] tracking-[0.01em]">
                Agentic RCM Solutions &middot; Claim Submission and Scrubbing
              </span>
            </div>

            {/* Headline */}
            <h2 className="type-h1 text-white tracking-[-0.01em]">
              Claims that go out clean the first time.
            </h2>

            {/* Description */}
            <p className="type-body-s text-[#F4F6F9] max-w-[650px]">
              Our agents review each claim against payer rules before submission, preventing delays caused by requests for information you have already provided.
            </p>
...
export default ClaimSubmissionHeroSection;
