...
const threeThingsCards: ThreeThingsCard[] = [
  {
    ...
    title: 'Start small',
    description:
      'You can begin with claim submission and add additional stages as needed.',
  },
  {
...
export const ThisIsntJustClaimSubmissionSection = () => {
        ...
        <div className="max-w-[1320px] mx-auto flex flex-col gap-[32px] lg:gap-[60px]">
          ...
          >
            ...
            <div className="w-full lg:w-[45%] xl:w-1/2 flex flex-col items-start gap-[12px] xl:gap-[20px] p-[24px] lg:p-[32px] xl:p-[60px] justify-center">
              <div className="flex items-center gap-[8px]">
                ...
                <span className="type-body-xxs text-[#F4F6F9] tracking-[0.01em]">
                  This isn&apos;t just a claim scrubber
                </span>
              </div>
              ...
              <p className="type-body-xs text-[#F4F6F9]">
                Claim submission operates on our proprietary HIMER AI OS, which also manages prior authorization, eligibility, denials, accounts receivable, cash posting, and coding. Each rejection our submission agent resolves becomes a rule for future coding.
              </p>
            ...
            <div className="w-full lg:w-[55%] xl:w-1/2 self-stretch flex items-center justify-end overflow-hidden">
              <div className="relative w-full h-full min-h-[380px] xl:min-h-[500px]">
                <Image
                  src="/images/solutions/solutions-claim-submission/this-isn't-just-an-eligibility-tool/img_this_isn't_just_an_eligibility_tool%20(1).png"
          ...
          >
            <div className="w-full overflow-hidden rounded-[20px] md:h-[380px] md:relative">
              <Image
                src="/images/solutions/solutions-claim-submission/this-isn't-just-an-eligibility-tool/img_this_isn't_just_an_eligibility_tool%20(2).png"
                alt="HIMER AI OS platform overview"
                width={724}
                height={596}
                priority
...
export default ThisIsntJustClaimSubmissionSection;
