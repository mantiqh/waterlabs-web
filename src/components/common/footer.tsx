      ...
      <div className="max-w-[1440px] mx-auto w-full">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-x-8 gap-y-12 lg:gap-12 mb-16">
          ...
          <div className="col-span-1 flex flex-col gap-6">
            <h4 className="body-xxs text-white font-medium">Platform</h4>
            <ul className="flex flex-col gap-4">
              <li>
                <Link href="#" className="body-xxs text-white/70 hover:text-electric-blue transition-colors">
                  Solutions
                </Link>
              </li>
              <li>
          ...
          {/* Products Links */}
          <div className="col-span-1 flex flex-col gap-6">
            <h4 className="body-xxs text-white font-medium">Products</h4>
            <ul className="flex flex-col gap-4">
              <li>
                <Link href="#" className="body-xxs text-white/70 hover:text-electric-blue transition-colors">
                  HIMER AI OS
          ...
          {/* Company Links */}
          <div className="col-span-1 flex flex-col gap-6">
            <h4 className="body-xxs text-white font-medium">Company</h4>
            <ul className="flex flex-col gap-4">
              <li>
                <Link href="#" className="body-xxs text-white/70 hover:text-electric-blue transition-colors">
                  About Us
          ...
          {/* Social Links */}
          <div className="col-span-1 flex flex-col gap-6">
            <h4 className="body-xxs text-white font-medium">Social</h4>
            <ul className="flex flex-col gap-4">
              <li>
                <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 body-xxs text-white/70 hover:text-electric-blue transition-colors group">
                  LinkedIn
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 lg:gap-0">
          <div className="order-2 lg:order-1 body-xxs text-white/70">
            © 2026 Waterlabs AI LLC. All rights reserved.
          </div>
          <div className="order-1 lg:order-2 flex flex-row gap-6">
            <Link href="#" className="body-xxs text-white/70 hover:text-white transition-colors">
              Terms & Conditions
            </Link>
            <Link href="#" className="body-xxs text-white/70 hover:text-white transition-colors">
              Privacy Policy
