...
export const BlogsCTASection = () => {
  return (
    <section className="relative w-full overflow-hidden p-0 m-0 bg-gradient-to-b from-[#F4F6F9] from-50% to-[#111111] to-50%">
      ...
      */}
      <div className="w-full bg-[#0F68D6] rounded-tl-[30px] rounded-bl-[30px] rounded-tr-0 rounded-br-0 px-[20px] md:px-[40px] lg:px-[60px] py-[32px] md:py-[40px] lg:py-0 lg:h-[140px] flex items-center overflow-hidden">
